...
namespace InsureFlowAPI.Controllers
{
    ...
    public class PolicyPlanController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllPlans([FromQuery] PolicyPlanQueryDto query)
        {
            ...
            return Ok(new ApiResponse<PagedResponse<PolicyPlanResponseDto>>
            {
                Success = true,
        ...
        public async Task<IActionResult> GetActivePlans()
        {
            ...
            return Ok(new ApiResponse<IEnumerable<PolicyPlanResponseDto>>
            {
                Success = true,
        ...
        public async Task<IActionResult> GetPlanById(int id)
        {
            ...
            return Ok(new ApiResponse<PolicyPlanResponseDto>
            {
                Success = true,
        ...
        [HttpPost]
        public async Task<IActionResult> CreatePlan(PolicyPlanRequestDto dto)
        {
            var plan = await _planService.CreatePlanAsync(dto);

            return CreatedAtAction(nameof(GetPlanById),
                new { id = plan.PlanId },
                new ApiResponse<PolicyPlanResponseDto>
                {
                    Success = true,
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id:int}")]
        public async Task<IActionResult> UpdatePlan(int id, PolicyPlanRequestDto dto)
        {
