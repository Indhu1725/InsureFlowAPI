...
namespace InsureFlowAPI.Services.Implementations
{
    public class ClaimService : IClaimService
    {
        ...
        public async Task<ClaimResponseDto?> GetClaimByIdAsync(int claimId, int userId, Role role)
        {
        ...
        public async Task<ClaimResponseDto> CreateClaimAsync(int userId, ClaimRequestDto requestDto)
        {
            ...
            try
            {
                ...
                if (!policy.Plan.Product.IsActive)
                ...
                var incidentDate = requestDto.IncidentDate;
        ...
        public async Task<ClaimDocumentResponseDto> AddClaimDocumentAsync(int userId, Role role, ClaimDocumentRequestDto requestDto)
        {
            if (role == Role.Customer)
            {
        ...
        public async Task<IEnumerable<ClaimDocumentResponseDto>> GetClaimDocumentsAsync(int claimId, int userId, Role role)
        {
            if (role == Role.Customer)
            {
        ...
        public async Task<IEnumerable<ClaimStatusHistoryResponseDto>> GetClaimStatusHistoryAsync(int claimId, int userId, Role role)
        {
            if (role == Role.Customer)
            {
                await ValidateClaimOwnershipAsync(claimId, userId);
        ...
        public async Task ReviewClaimByStaffAsync(int claimId, int staffUserId, ClaimReviewDto requestDto)
        {
            ...
            if (staff.Role != Role.InternalStaff)
            ...
            claim.InternalStaffRemarks = requestDto.Remarks.Trim();
