...
namespace InsureFlowAPI.Services.Implementations
{
    public class PolicyService : IPolicyService
    {
        ...
        IPolicyPlanRepository planRepository,IMapper mapper,ILogger<PolicyService> logger)
        {
        ...
        public async Task<PagedResponse<PolicyResponseDto>> GetAllPoliciesAsync(PolicyQueryDto query)
        {
            ...
            _logger.LogInformation("Retrieved policy list. Page={Page}, PageSize={PageSize}",query.PageNumber,query.PageSize);
        ...
        public async Task<PolicyResponseDto> PurchasePolicyAsync(int customerUserId,PurchasePolicyRequestDto requestDto)
        {
            ...
            // CHECK WHETHER CUSTOMER ALREADY HAS THIS PLAN
            ...
            var policy = new Policy
            {
                ...
                EndDate = requestDto.StartDate.AddYears(plan.DurationYears),
            ...
            _logger.LogInformation("Policy {PolicyNumber} purchased by Customer {CustomerId}.",policy.PolicyNumber,customer.CustomerId);
        ...
        public async Task<PolicyResponseDto> IssuePolicyByInternalStaffAsync(IssuePolicyRequestDto requestDto)
        {
            ...
            _logger.LogInformation("Policy {PolicyNumber} issued to Customer {CustomerId}.",policy.PolicyNumber,customer.CustomerId);
        ...
        private async Task<string> GeneratePolicyNumberAsync()
        {
            ...
            do
            {
                policyNumber = $"POL-{DateTime.UtcNow:yyMMddHHmm}";
